...
export const carsList : CarInfo[] = [
    ...
    {name : 'Scoda Rapid', price : 'Rs. 7.99 - 13.45 Lakh*', type : CarType.Sedan, image : skoda},
    {name : 'Honda City 4th Gen', price : 'Rs. 9.29 - 9.99 Lakh*', type : CarType.Sedan, image : hondaCity},
    {name : 'Maruti DZire', price : 'Rs. 5.99 - 9.08 Lakh*', type : CarType.Sedan, image : marutiDzire},
    {name : 'Hyundai Verna', price : 'Rs. 9.29 - 15.32 Lakh*', type : CarType.Sedan, image : verna},
    {name : 'Mahindra XUV700', price : 'Rs. 11.99 - 14.92 Lakh*', type : CarType.SUV, image : mahindra},
    {name : 'Mahindra Thar', price : 'Rs. 12.99 - 14.92 Lakh*', type : CarType.SUV, image : thar},
    {name : 'Hyundai Creta', price : 'Rs. 10.99 - 14.92 Lakh*', type : CarType.SUV, image : creta},
    {name : 'Kia Seltos', price : 'Rs. 9.99 - 14.92 Lakh*', type : CarType.SUV, image : kia},
]